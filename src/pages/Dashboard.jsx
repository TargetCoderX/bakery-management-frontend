...
function Dashboard() {
    ...
    return (
        <Authlayout>
                        ...
                        <div className="row g-2 align-items-center">
                            ...
                            <div className="col-auto ms-auto d-print-none">
                                <div className="btn-list">
                                    <button className="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-add-customer">
            ...
            <div className="modal modal-blur fade" id="modal-add-customer" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value={newCustomer.name} onChange={(e) => { newCustomerONChangeHandle(e) }} name="name" placeholder="Customer Name" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Email</label>
                                <input type="text" className="form-control" value={newCustomer.email} onChange={(e) => { newCustomerONChangeHandle(e) }} name="email" placeholder="Customer Email" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Phone</label>
                                <input type="text" className="form-control" value={newCustomer.phone} onChange={(e) => { newCustomerONChangeHandle(e) }} name="phone" placeholder="Customer Phone" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Address</label>
                                <input type="text" className="form-control" value={newCustomer.address} onChange={(e) => { newCustomerONChangeHandle(e) }} name="address" placeholder="Customer Address" />
                            </div>
                        </div>
                        <div className="modal-footer">
                            ...
                            <button className="btn btn-primary ms-auto" data-bs-dismiss="modal" onClick={(e) => { submitNewCustomer(e) }}>
